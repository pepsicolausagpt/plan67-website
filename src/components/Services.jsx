...
function Services() {
  const services = [
    ...
    { title: 'Покос травы', desc: 'Профессиональный покос травы и бурьяна на заросших участках. Триммер или газонокосилка.', price: 'от 600 руб/100 м²' },
    { title: 'Установка бордюров', desc: 'Монтаж садовых и дорожных бордюров для фиксации края мощения и разделения зон участка.', price: 'от 600 руб/м.п.' },
    { title: 'Дренажные лотки', desc: 'Монтаж водоотводных лотков и ливневой канализации для защиты участка от затопления.', price: 'от 600 руб/м.п.' }
  ];
